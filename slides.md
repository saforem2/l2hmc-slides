...
1. **Update** $v$:
`\[v' = v \cdot \exp\left[\varepsilon \color{#ff5252}{S_{v}}\left(x, \partial_{x}U\right)\right] - \frac{\varepsilon}{2} \bigg[\partial_{x} U\cdot \exp\left[\varepsilon \color{#ff5252}{Q_{v}}\left(x\right)\right] + \color{#ff5252}{T_{v}}\left(x\right)\bigg]\]`
2. **Update** $x$ (in two parts):
